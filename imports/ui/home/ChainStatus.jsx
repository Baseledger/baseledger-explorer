                    ...
                    <Row className="status text-center">
                        ...
                        <Col lg={3} md={6}>
                            <Card body>
                                ...
                                <CardText><span className="display-4 value text-primary">{this.state.votingPower}</span><T percent={numbro(this.state.numValidators/this.state.totalNumValidators).format("0.00%")} totalStakes={numbro(this.state.totalNumValidators).format("0.00a")} denom='vote' denomPlural='votes'>chainStatus.fromTotalStakes</T></CardText>
                            </Card>
                        </Col>
                    </Row>
                )
