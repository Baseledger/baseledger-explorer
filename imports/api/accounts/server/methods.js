...
Meteor.methods({
    'accounts.getAccountDetail': function(address){
        console.log("FIXME: accounts.getAccountDetail")
        // this.unblock();
    ...
    'accounts.getBalance': function(address){
        console.log("FIXME: accounts.getBalance")
        // this.unblock();
        // let balance = {}

        // get available atoms
        // let url = API + '/balances/'+ address;
        // try{
        //     let available = HTTP.get(url);
        //     if (available.statusCode == 200){
        ...
        // }
        // get unbonding
        // url = API + '/delegators/'+address+'/unbonding_delegations';
        // try{
        ...
        // get rewards
        // url = API + '/distribution/v1beta1/delegators/'+address+'/rewards';
        // try{
        ...
        // if (validator) {
        //     let url = API + '/distribution/v1beta1/validators/'+validator.operator_address+'/commission';
    ...
    'accounts.getDelegation'(address, validator){
        console.log("FIXME: accounts.getDelegation")
        // this.unblock();
        // let url = `/validators/${validator}/delegations/${address}`;
        ...
        // url = `/delegators/${address}/redelegations?dst_validator_addr=${validator}`;
        ...
        // url = `/validators/${validator}/delegations/${address}/unbonding_delegation`;
    ...
    'accounts.getAllDelegations'(address){
        console.log("FIXME: accounts.getAllDelegations")
        // this.unblock();
        // let url = API + '/delegators/'+address+'/delegations';
    ...
    'accounts.getAllUnbondings'(address){
        console.log("FIXME: accounts.getAllUnbondings")
        // this.unblock();
        // let url = API + '/delegators/'+address+'/unbonding_delegations';
    ...
    'accounts.getAllRedelegations'(address, validator){
        console.log("FIXME: accounts.getAllRedelegations")
        // this.unblock();        
        // let url = `/v1beta1/delegators/${address}/redelegations&src_validator_addr=${validator}`;
        // try{
    ...
    'accounts.getRedelegations'(address) {
        console.log("FIXME: accounts.getRedelegations")
        // this.unblock();
        // let url = API + '/v1beta1/delegators/' + address +'/redelegations';
