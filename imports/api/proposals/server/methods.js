...
Meteor.methods({
    'proposals.getProposals': function(){
        ...
        // let url = API + '/gov/params/tallying';
        // try{
    ...
    //                     url = API + '/gov/proposals/'+proposals[i].proposalId+'/deposits?pagination.limit=2000&pagination.count_total=true';
    //                     let response = HTTP.get(url);
    ...
    //                     url = API + '/gov/proposals/'+proposals[i].proposalId+'/votes?pagination.limit=2000&pagination.count_total=true';
    //                     response = HTTP.get(url);
    //                     if (response.statusCode == 200){
